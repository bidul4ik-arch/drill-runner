...
for name,pos,target in [('explorer',(2.7,4.7,2.6),(0,0,1.12))]:
 col=bpy.data.collections[name]
 for o in col.objects:o.hide_render=o.name.startswith("CapAccessory")
 scene.frame_set(1)
 ...
 scene.render.filepath=ROOT+'/Art/Renders/'+name+'-mobile-reference.png';bpy.ops.render.render(write_still=True)
